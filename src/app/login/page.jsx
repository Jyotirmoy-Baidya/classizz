...
const LoginPage = () => {
    ...
    return (
        //Mobile Login
        <div className='flex flex-col gap-4 mt-56 items-center'>
            <div className='logo-classizz'>
                <Image src="/logo.jpg" alt="logo" width={160} height={160} />
            </div>
            <div className='flex flex-col gap-4 mt-3 w-full justify-center items-center login-up-form'>
                ...
                {
                    btnDisabled ?
                        <button className='bg-purple-200 py-2 px-4 rounded mt-2 tracking-wider uppercase' onClick={() => toast.error("Fill all the fields")}>Login</button> :
                        <button onClick={signUp} className='bg-purple-600 py-2 px-4 rounded mt-2 tracking-wider uppercase'>Login</button>
                }
            </div>
