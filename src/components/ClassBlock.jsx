...
const ClassBlock = ({ content }) => {
    return (
        <div className={`h-36 w-auto min-w-[340px] max-w-[380px] p-6 border-[1px] border-${content.color}-500 bg-${content.color}-100 hover:border-[2.5px] cursor-pointer text-black dark:text-slate-700 shrink-0 flex justify-between rounded-md home-class-block`} >
